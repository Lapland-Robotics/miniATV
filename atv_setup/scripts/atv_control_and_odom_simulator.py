...
rospy.Subscriber(ackermann_cmd_topic,AckermannDriveStamped, atv_state_cmd_callback, queue_size=1)
...
rospy.loginfo("Node 'atv_control_and_odom' started.\nListening to %s,%s, publishing to %s,%s. Frame id: %s, wheelbase: %f", twist_cmd_topic,ackermann_cmd_topic, "/odom" ,ackermann_cmd_topic, odom_frame_id, wheelbase)

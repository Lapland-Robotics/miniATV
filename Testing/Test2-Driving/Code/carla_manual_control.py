...
class World(object):
    ...
    def cb_display_real_gps_position(self, data): # CS
        ...
        if miniATV_gnss_hor_acc < 2: #initially, the horizontal accuracy can be more than 10 m, in that case do not obstruct the whole screen
            ...
            pt_point_size = 2
        self.world.debug.draw_line(miniATV_location, miniATV_location+carla.Location(x=0, y=0, z=(2)), thickness=0.01, color=carla.Color( 255, 0, 0 ), life_time=draw_life_time)

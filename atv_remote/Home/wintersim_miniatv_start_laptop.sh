...
gnome-terminal --tab -e "roslaunch carla_ros_bridge carla_ros_bridge_with_example_ego_vehicle.launch"
gnome-terminal --tab -e "roslaunch carla_ackermann_control carla_ackermann_control.launch"
